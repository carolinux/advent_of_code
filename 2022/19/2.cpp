// perhaps set instead of unordered set is faster
// <set> finished in 70 mins
...
void try_insert(unordered_map<t4, set<t4>> & states, t4& key, t4& val) {
...
int main() {
	...
	while (getline(cin, line)) {
		...
		unordered_map<t4, set<t4>> states;
		set<t4> sset;
	...
	for (int steps=1;steps<=limit;steps++) {
		...
		unordered_map<t4, set<t4>> states2;

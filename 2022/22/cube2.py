...
def calculate(row, col, code):
    ...
    # LD and RU needed to be redone, they had simply row for the column before
    elif code == 'LD':
    ...
    # could this here be symmetric to the first group, ie col instead of 0/MAX
    # i think yes
    elif code == 'LL':
        return R, MAX-row, col
    elif code == 'RR':
        return L, MAX-row, col
    elif code == 'UU':
        return D, row, MAX-col
    elif code == 'DD':
        return U, row, MAX-col
...
if fn != 'small.txt':
    ...
    # lrud
    faces.append(Face(1, (0,50), 'L4L2L6U3'))
    faces.append(Face(2, (0,100), 'R1R5D6R3'))
    faces.append(Face(3, (50,50), 'U4D2D1U5'))
    faces.append(Face(4, (100,0), 'L1L5L3U6'))
    faces.append(Face(5, (100,50), 'R4R2D3R6'))
    faces.append(Face(6, (150,0), 'U1D5D4U2'))
else:
...
print(res)
print(f"Used {len(used_codes)}, {used_codes}")
